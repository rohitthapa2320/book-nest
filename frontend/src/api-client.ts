import { BookingFormData } from "./forms/booking";
...
const API_BASE_URL =
  import.meta.env.VITE_API_BASE_URL || "https://hotelhub-com.onrender.com";
...
export const signOut = async () => {
  ...
  if (!response.ok) {
    throw new Error("Error occured during sign out.");
  }
};
...
export const fetchMyHotelDetailsById = async (
  hotelId: string
): Promise<HotelType> => {
...
export const fetchHotelDetailsById = async (
  hotelId: string
): Promise<HotelType> => {
